<div class="grid grid-cols-1 xl:grid-cols-3 gap-8 my-8">
        ...
        <div class="text-center">
            <div class="relative inline-flex items-center justify-center">
                <svg class="w-32 h-32" viewBox="0 0 120 120">
                    ...
                    <circle class="stroke-current text-primary -rotate-90 origin-center" cx="60" cy="60" fill="transparent" r="54" stroke-dasharray="339.292" stroke-dashoffset="<?php echo e(339.292 - (339.292 * $goalProgress / 100)); ?>" stroke-linecap="round" stroke-width="12"></circle>
                </svg>
                <div class="absolute flex flex-col items-center">
                    <span class="text-3xl font-bold text-heading-light dark:text-heading-dark"><?php echo e(number_format($goalProgress, 0)); ?>%</span>
                </div>
            </div>
            <p class="text-lg font-medium text-heading-light dark:text-heading-dark mt-4">$<?php echo e(number_format($currentEarnings, 2)); ?> / $<?php echo e(number_format($monthlyGoal, 2)); ?></p>
    ...
    <div class="xl:col-span-2 bg-card-light dark:bg-card-dark p-6 rounded-xl shadow-md">
        ...
        <div class="space-y-4">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center gap-4">
                    <div class="flex-grow">
                        <div class="flex justify-between items-center mb-1">
                            <div class="flex items-center gap-2">
                                <span class="fi fi-<?php echo e(strtolower($country['iso_code'])); ?>"></span>
                                <span class="text-heading-light dark:text-heading-dark font-medium"><?php echo e($country['name']); ?></span>
                            </div>
                            <span class="font-bold text-sm text-heading-light dark:text-heading-dark"><?php echo e($country['clicks']); ?> Clicks</span>
                        </div>
                        <div class="w-full bg-background-light dark:bg-background-dark rounded-full h-1.5">
                            <div class="bg-primary h-1.5 rounded-full" style="width: <?php echo e($country['percentage']); ?>%"></div>
                        </div>
                    </div>
                </div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showGoalModal): ?>
        ...
        <div class="w-full max-w-md rounded-xl border border-gray-200 bg-background-light dark:border-gray-800 dark:bg-background-dark shadow-xl" @click.away="$wire.closeGoalModal()">
            ...
            <div class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['newGoal'];
