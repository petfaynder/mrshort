...
<div class="cta-section">
    <div>
        <h2>Ready to start earning with <?php echo e(config('app.name')); ?>?</h2>
        <p>Register your account and start the journey. It is 100% free!</p>
    </div>
    <a href="<?php echo e(route('register')); ?>" class="cta-button">Sign up</a>
</div>
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/partials/info_section.blade.php ENDPATH**/ ?>