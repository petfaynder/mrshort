    ...
    <aside class="w-64 bg-card-light dark:bg-card-dark flex flex-col p-4 border-r border-border-light dark:border-border-dark overflow-y-auto">
        ...
        <nav class="flex-grow">
            <ul>
                ...
                <li class="mb-2" x-data="{ open: <?php echo e(request()->routeIs('user.contact') ? 'true' : 'false'); ?> }">
                    <button @click="open = !open" class="flex items-center justify-between w-full px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-text-light dark:text-text-dark <?php echo e(request()->routeIs('user.contact') ? 'bg-blue-50 dark:bg-blue-900/30' : ''); ?>">
                        <span class="flex items-center gap-3">
                    ...
                    <ul x-cloak x-show="open" x-collapse class="mt-2 ml-4 space-y-1 border-l-2 border-gray-200 dark:border-gray-700 pl-2">
                        ...
                        <li>
                            <a class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm <?php echo e(request()->routeIs('feedback.*') ? 'bg-blue-100 dark:bg-blue-900/50 text-primary font-semibold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-text-light dark:text-text-dark'); ?>" 
                        ...
                        <li>
                            <a data-tutorial="nav-contact" class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm <?php echo e(request()->routeIs('user.contact') ? 'bg-blue-100 dark:bg-blue-900/50 text-primary font-semibold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-text-light dark:text-text-dark'); ?>" 
                               href="<?php echo e(route('user.contact')); ?>">
