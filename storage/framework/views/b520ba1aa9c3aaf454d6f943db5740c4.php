        ...
        <div class="flex flex-col w-full lg:w-1/2 items-center justify-center p-6 sm:p-8 md:p-12">
            <div class="flex flex-col max-w-md w-full gap-6 form-item-container">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full animate-form-item" style="animation-delay: 0.2s;">
                    <a href="<?php echo e(route('auth.google')); ?>" class="flex-1 flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-300 hover:scale-105 active:scale-95">
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="flex flex-col gap-4">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="referral_code" value="<?php echo e(request('referral_code', request('ref'))); ?>">
                    <div class="flex flex-col sm:flex-row gap-4 w-full animate-form-item" style="animation-delay: 0.4s;">
                        ...
                        <div class="flex flex-col w-full">
                            <label class="flex flex-col w-full">
                                ...
                                <div class="relative w-full">
                                    <input name="first_name" value="<?php echo e(old('first_name')); ?>" required autofocus autocomplete="given-name" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-black dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border <?php echo e($errors->has('first_name') ? 'border-danger bg-danger/10' : 'border-slate-200 dark:border-slate-700 bg-transparent dark:bg-transparent'); ?> h-12 placeholder:text-slate-400 dark:placeholder:text-slate-500 px-4 text-base font-normal leading-normal transition-all duration-300" placeholder="Enter your first name"/>
                            ...
                            <?php if($errors->has('first_name')): ?>
                                <p class="error-message flex items-center gap-1.5 mt-1.5 text-sm text-danger dark:text-red-400" style="display: flex;">
                                    ...
                                    <span><?php echo e($errors->first('first_name')); ?></span>
                                </p>
                            <?php endif; ?>
                        </div>
                        <!-- Last Name -->
                        <div class="flex flex-col w-full">
                            <label class="flex flex-col w-full">
                                ...
                                <div class="relative w-full">
                                    <input name="last_name" value="<?php echo e(old('last_name')); ?>" required autocomplete="family-name" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-black dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border <?php echo e($errors->has('last_name') ? 'border-danger bg-danger/10' : 'border-slate-200 dark:border-slate-700 bg-transparent dark:bg-transparent'); ?> h-12 placeholder:text-slate-400 dark:placeholder:text-slate-500 px-4 text-base font-normal leading-normal transition-all duration-300" placeholder="Enter your last name"/>
                            ...
                            <?php if($errors->has('last_name')): ?>
                                <p class="error-message flex items-center gap-1.5 mt-1.5 text-sm text-danger dark:text-red-400" style="display: flex;">
                                    <span class="material-symbols-outlined text-base">arrow_right_alt</span>
                                    <span><?php echo e($errors->first('last_name')); ?></span>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col w-full animate-form-item" style="animation-delay: 0.5s;">
                        <label class="flex flex-col w-full">
                            ...
                            <div class="relative w-full">
                                <input name="email" type="email" value="<?php echo e(old('email')); ?>" required autocomplete="username" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-black dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border <?php echo e($errors->has('email') ? 'border-danger bg-danger/10' : 'border-slate-200 dark:border-slate-700 bg-transparent dark:bg-transparent'); ?> h-12 placeholder:text-slate-400 dark:placeholder:text-slate-500 px-4 text-base font-normal leading-normal transition-all duration-300" placeholder="Enter your email"/>
                    ...
                    <div class="flex flex-col w-full animate-form-item" style="animation-delay: 0.7s;">
                        <label class="flex flex-col w-full">
                            ...
                            <div class="relative w-full">
                                <input name="password_confirmation" type="password" required autocomplete="new-password" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-black dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border <?php echo e($errors->has('password_confirmation') ? 'border-danger bg-danger/10' : 'border-slate-200 dark:border-slate-700 bg-transparent dark:bg-transparent'); ?> h-12 placeholder:text-slate-400 dark:placeholder:text-slate-500 px-4 text-base font-normal leading-normal transition-all duration-300" placeholder="Confirm your password"/>
                    ...
                    <div class="flex items-center gap-3 animate-form-item" style="animation-delay: 0.8s;">
                        ...
                        I agree to the <a class="text-primary hover:underline font-medium" href="<?php echo e(route('terms.of.service')); ?>">Terms of Service</a> and <a class="text-primary hover:underline font-medium" href="<?php echo e(route('privacy.policy')); ?>">Privacy Policy</a>.
                        </label>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.captcha','data' => ['form' => 'register']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['form' => 'register']); ?>
...
<?php endif; ?>
                ...
                <p class="text-center text-sm text-slate-600 dark:text-slate-400 animate-form-item" style="animation-delay: 1s;">
                    Already have an account? <a class="text-primary hover:underline font-medium" href="<?php echo e(route('login')); ?>">Log In</a>
                </p>
            </div>
        </div>
...
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/auth/register.blade.php ENDPATH**/ ?>