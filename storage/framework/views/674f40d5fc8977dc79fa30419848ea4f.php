            ...
            >
                ...
                <div class="relative inline-block mb-4">
                    ...
                    <div class="relative w-24 h-24 mx-auto bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center animate-bounce">
                        <span class="text-5xl"><?php echo e($milestoneIcon); ?></span>
                    </div>
                </div>

                <!-- Title -->
                <h2 class="text-3xl font-bold text-white mb-2 animate-pulse">
                    <?php echo e($milestoneName); ?>

                </h2>
                
                <!-- Description -->
                <p class="text-gray-300 mb-4">
                    <?php echo e($milestoneDescription); ?>

                </p>

                <!-- Rewards -->
                <div class="flex justify-center gap-4 mb-6">
                    <!--[if BLOCK]><![endif]--><?php if($pointsEarned > 0): ?>
                        <div class="bg-purple-600/20 border border-purple-500/30 rounded-xl px-4 py-2">
                            <div class="text-2xl font-bold text-purple-400">+<?php echo e(number_format($pointsEarned)); ?></div>
                            <div class="text-xs text-purple-300">Points</div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if($badgeEarned): ?>
                        <div class="bg-amber-600/20 border border-amber-500/30 rounded-xl px-4 py-2">
                            <div class="text-2xl"><?php echo e($badgeEarned['icon'] ?? '🏅'); ?></div>
                            <div class="text-xs text-amber-300"><?php echo e($badgeEarned['name'] ?? 'Badge'); ?></div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex justify-center gap-3">
                        ...
                        <button 
                            onclick="navigator.share ? navigator.share({title: '<?php echo e($milestoneName); ?>', url: '<?php echo e(config('app.url')); ?>'}) : alert('Sharing not supported')"
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/livewire/user/milestone-modal.blade.php ENDPATH**/ ?>