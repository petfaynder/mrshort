...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($isTelegramPromotion): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="bg-[#FFFFFF] dark:bg-[#1F2937] p-6 md:p-8 rounded-lg shadow-sm border border-[#E5E7EB] dark:border-[#374151]">
                ...
                <div class="space-y-4">
                    <!-- Pay with Balance -->
                    <label class="relative flex items-center p-4 rounded-lg border <?php echo e($payment_method === 'balance' ? 'border-[#3B82F6] bg-blue-50 dark:bg-blue-900/20' : 'border-[#E5E7EB] dark:border-[#374151] hover:bg-gray-50 dark:hover:bg-gray-800'); ?> cursor-pointer transition-all">
                        <input type="radio" wire:model.live="payment_method" value="balance" class="h-4 w-4 text-[#3B82F6] border-gray-300 focus:ring-[#3B82F6] bg-gray-100 dark:bg-gray-700" 
                            <?php if(Auth::user()->earnings < 10 || Auth::user()->earnings < $calculated_cost): ?> disabled <?php endif; ?>>
                        <div class="ml-4 flex-1">
                            <div class="flex items-center justify-between">
                                <span class="block text-sm font-medium text-[#111827] dark:text-[#F9FAFB]">
                                    Pay with Balance
                                </span>
                                <span class="text-xs font-semibold px-2.5 py-0.5 rounded <?php echo e(Auth::user()->earnings >= 10 && Auth::user()->earnings >= $calculated_cost ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300'); ?>">
                                    Current: $<?php echo e(number_format(Auth::user()->earnings, 2)); ?>
                            ...
                            <p class="mt-1 text-xs text-[#6B7280] dark:text-[#9CA3AF]">
                             ...
                             <?php if(Auth::user()->earnings < 10): ?>
                                <p class="mt-1 text-xs text-red-500">Insufficient balance (Min $10).</p>
                            <?php elseif(Auth::user()->earnings < $calculated_cost): ?>
                    ...
                    <!-- Pay with Crypto -->
                    <label class="relative flex items-center p-4 rounded-lg border <?php echo e($payment_method === 'crypto' ? 'border-[#3B82F6] bg-blue-50 dark:bg-blue-900/20' : 'border-[#E5E7EB] dark:border-[#374151] hover:bg-gray-50 dark:hover:bg-gray-800'); ?> cursor-pointer transition-all">
                ...
                <div class="space-y-4 text-sm">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="font-medium text-[#111827] dark:text-[#F9FAFB]">
                                <!--[if BLOCK]><![endif]--><?php if($payment_method === 'balance'): ?>
                                    Balance ($<?php echo e(number_format(Auth::user()->earnings, 2)); ?>)
...
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/livewire/user/create-ad-campaign.blade.php ENDPATH**/ ?>