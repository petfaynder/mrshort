        ...
        <label class="flex flex-col w-full">
            <div class="flex justify-between items-center pb-2">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="text-sm font-medium text-primary hover:underline" href="<?php echo e(route('password.request')); ?>">Forgot password?</a>
                <?php endif; ?>
            </div>
            <div class="relative w-full">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.captcha','data' => ['form' => 'login']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['form' => 'login']); ?>
...
<p class="text-center text-sm text-slate-600 dark:text-slate-400 animate-form-item" style="animation-delay: 0.8s;">
    Don't have an account? <a class="text-primary hover:underline font-medium" href="<?php echo e(route('register')); ?>">Sign up</a>
</p>
</div>
</div>
...
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/auth/login.blade.php ENDPATH**/ ?>