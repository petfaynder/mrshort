        ...
        <div class="relative z-10 w-full max-w-5xl px-4 flex flex-col items-center text-center">
            ...
            <div x-data="{ 
                ...
                submit() {
                    ...
                    this.shortened = '';
                    this.copied = false;
                    fetch('<?php echo e(route('guest.shorten')); ?>', {
                        method: 'POST',
                        headers: {
    ...
    <div class="bg-[#050505] py-24 sm:py-32 px-4 sm:px-8 relative border-t border-white/5">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mt-20 text-center gsap-reveal">
                <a class="inline-flex items-center gap-2 bg-gradient-to-r from-electric-blue to-bright-magenta text-white font-bold py-4 px-10 rounded-full hover:scale-105 hover:shadow-[0_0_20px_rgba(0,191,255,0.5)] transition-all duration-300 text-lg group" href="<?php echo e(route('register')); ?>">
    ...
    <div class="bg-[#050505] py-24 sm:py-32 px-4 sm:px-8 relative border-t border-white/5">
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            ...
            <div class="mt-12 text-center gsap-reveal">
                <a class="inline-block border border-white/20 hover:bg-white/10 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 tracking-wider text-sm" href="<?php echo e(route('payout.rates')); ?>">
                    VIEW ALL COUNTRIES
                </a>
            </div>
        </div>
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            <div class="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-md border border-gray-700/50 rounded-3xl p-8 md:p-12 shadow-2xl gsap-reveal">
                ...
                <div class="mt-12 text-center border-t border-gray-700/50 pt-8">
                    <a class="inline-block bg-white text-gray-900 font-bold py-4 px-10 rounded-full hover:bg-gray-200 hover:scale-105 transition-all duration-300 text-lg shadow-lg" href="<?php echo e(route('register')); ?>">Start Earning Now</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-10 hover:border-white/20 transition-all duration-300 flex flex-col items-start group gsap-reveal">
                    ...
                    <a class="font-bold text-electric-blue hover:text-white transition-colors duration-300 flex items-center group mt-auto" href="<?php echo e(route('register')); ?>">
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-10 hover:border-white/20 transition-all duration-300 flex flex-col items-start group gsap-reveal" style="transition-delay: 100ms;">
                    ...
                    <a class="font-bold text-bright-magenta hover:text-white transition-colors duration-300 flex items-center group mt-auto" href="<?php echo e(route('api.documentation')); ?>">
...
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/welcome.blade.php ENDPATH**/ ?>