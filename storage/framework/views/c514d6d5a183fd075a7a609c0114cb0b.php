    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                 <div>
                   <a href="<?php echo e(route('feedback.index')); ?>" class="text-gray-500 hover:text-gray-700 flex items-center gap-2 mb-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700 text-center">
                    <button wire:click="vote" class="w-full flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all duration-200 <?php echo e($post->isVotedBy(auth()->user()) ? 'bg-blue-50 border-blue-500 text-blue-600 dark:bg-blue-900/20' : 'bg-gray-50 border-gray-200 text-gray-500 hover:border-blue-300 hover:bg-blue-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mb-1" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-3xl font-bold"><?php echo e($post->vote_count); ?></span>
                        <span class="text-xs uppercase tracking-wider font-semibold mt-1">Votes</span>
                    </button>
                    <p class="mt-3 text-sm text-gray-500">
                        <?php echo e($post->isVotedBy(auth()->user()) ? 'You voted for this' : 'Click to support this idea'); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700 space-y-4">
                     <div>
                        ...
                        ?>
                        <div class="mt-1">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($colors[$post->status]); ?>">
                                <?php echo e($label); ?>
                     ...
                     <div>
                        ...
                        <div class="mt-1 flex items-center gap-2">
                             ...
                             <span class="text-sm text-gray-900 dark:text-white"><?php echo e($post->user->name); ?></span>
                        </div>
            ...
            <div class="lg:col-span-3 space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 border border-gray-100 dark:border-gray-700">
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-4"><?php echo e($post->title); ?></h1>
                ...
                <!--[if BLOCK]><![endif]--><?php if($post->comments->where('is_official_response', true)->count() > 0): ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                    <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-t-lg">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Discussion (<?php echo e($post->comments_count); ?>)</h3>
                    </div>
                                    ...
                                    <div class="flex-1">
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                            <div class="flex items-center justify-between mb-2">
                                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($comment->user->name); ?></span>
...
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/livewire/feedback/feedback-detail.blade.php ENDPATH**/ ?>