...
<?php if(!empty($thirdPartyAdCodes) && is_array($thirdPartyAdCodes)): ?>
    <?php $__currentLoopData = $thirdPartyAdCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adCode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(!empty($adCode['code'])): ?>
<script>
    // Third Party Ad: <?php echo e($adCode['name'] ?? 'Unknown'); ?> - Step <?php echo e($stepNumber); ?>

    (function() {
        try {
            <?php echo $adCode['code']; ?>

        } catch(e) {
            console.error('Third party ad error (<?php echo e($adCode['name'] ?? 'unknown'); ?>):', e);
        }
    })();
</script>
        <?php endif; ?>
