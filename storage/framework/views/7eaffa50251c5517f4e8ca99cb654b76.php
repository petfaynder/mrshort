            ...
            <div class="relative transform overflow-hidden rounded-xl bg-white dark:bg-gray-800 shadow-2xl transition-all w-full max-w-lg">
                ...
                <div class="px-6 py-6">
                    <div class="mb-5 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                        ...
                        <p class="text-red-800 dark:text-red-200 font-medium mt-1"><?php echo e($reason); ?></p>
                    </div>
                    
                    <!--[if BLOCK]><![endif]--><?php if($deactivatedAt): ?>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        <span class="font-medium">Deactivated on:</span> <?php echo e($deactivatedAt); ?>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 px-6 py-4 flex gap-3 justify-center">
                    <!--[if BLOCK]><![endif]--><?php if($isImpersonating): ?>
                    <button 
                        wire:click="dismiss" 
                        type="button" 
...
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/livewire/user/deactivated-account-modal.blade.php ENDPATH**/ ?>