            ...
            <form wire:submit.prevent="submit" class="space-y-5">
                ...
                <div class="bg-white/[0.03] border border-white/10 rounded-2xl p-5">
                    ...
                    <div class="bg-black/30 rounded-xl px-4 py-3 border border-white/5">
                        <code class="text-[#00BFFF] font-mono text-base md:text-lg break-all"><?php echo e(url('/' . $linkCode)); ?></code>
                    </div>
                </div>
                ...
                <div class="bg-white/[0.03] border border-white/10 rounded-2xl p-5 hover:border-white/20 transition-colors">
                    ...
                    >
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $complaintTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </select>
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['complaintType'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="bg-white/[0.03] border border-white/10 rounded-2xl p-5 hover:border-white/20 transition-colors">
                        ...
                        >
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['reporterName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/livewire/dmca-complaint-form.blade.php ENDPATH**/ ?>