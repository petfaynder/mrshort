<div x-data="{ showConfirmModal: <?php if ((object) ('showConfirmModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showConfirmModal'->value()); ?>')<?php echo e('showConfirmModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showConfirmModal'); ?>')<?php endif; ?>, countrySearch: '' }">
     <?php $__env->slot('header', null, []); ?> 
        <header class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-[#111827] dark:text-[#F9FAFB]">Edit Campaign</h1>
                <p class="text-md text-[#6B7280] dark:text-[#9CA3AF] mt-1">Update your campaign details.</p>
            </div>
            <div class="flex items-center gap-4 mt-4 sm:mt-0">
                ...
                <div class="flex items-center gap-2">
                    <img alt="User avatar" class="w-8 h-8 rounded-full" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&size=40&background=0D8ABC&color=fff"/>
                    <div>
                        <p class="text-sm font-semibold text-[#111827] dark:text-[#F9FAFB]"><?php echo e(Auth::user()->name); ?></p>
                        <p class="text-xs text-[#6B7280] dark:text-[#9CA3AF]">Balance: $<?php echo e(number_format(Auth::user()->balance, 2)); ?></p>
                    </div>
                </div>
            </div>
        </header>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        <p class="mt-2 text-xs text-[#6B7280] dark:text-[#9CA3AF]">A unique name for your campaign.</p>
                    </div>
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['desired_clicks'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input class="w-full bg-[#F3F4F6] dark:bg-[#374151] border-transparent text-[#6B7280] dark:text-[#9CA3AF] rounded-md cursor-not-allowed" disabled="" id="estimated-cost" type="text" value="$<?php echo e(number_format($calculated_cost, 2)); ?>"/>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['popup_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        <p class="mt-2 text-xs text-[#6B7280] dark:text-[#9CA3AF]">The destination link for your campaign.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 max-h-48 overflow-y-auto p-2 border border-[#E5E7EB] dark:border-[#374151] rounded-md">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label wire:key="country-<?php echo e($country->id); ?>" x-show="'<?php echo e(strtolower($country->name)); ?>'.includes(countrySearch.toLowerCase())" class="flex items-center space-x-2 cursor-pointer p-1 hover:bg-[#F3F4F6] dark:hover:bg-[#111827] rounded">
                                    <input type="checkbox" wire:model.live="selectedCountries" value="<?php echo e($country->iso_code); ?>" class="rounded border-gray-300 text-[#3B82F6] focus:ring-[#3B82F6] bg-gray-100 dark:bg-gray-700">
                                    <span class="fi fi-<?php echo e(strtolower($country->iso_code)); ?> mr-1"></span>
                                    <span class="text-sm text-[#111827] dark:text-[#F9FAFB]"><?php echo e($country->name); ?></span>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                         <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedCountries'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $ageRanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label wire:key="age-<?php echo e($loop->index); ?>" class="cursor-pointer">
                                    <input type="checkbox" wire:model.live="selectedAgeRanges" value="<?php echo e($range); ?>" class="sr-only peer">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedAgeRanges'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                             <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $deviceOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label wire:key="device-<?php echo e($key); ?>" class="cursor-pointer">
                                    <input type="checkbox" wire:model.live="selectedDevices" value="<?php echo e($key); ?>" class="sr-only peer">
                                    <div class="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium bg-[#F3F4F6] dark:bg-[#374151] text-[#111827] dark:text-[#F9FAFB] peer-checked:bg-[#DBEAFE] dark:peer-checked:bg-[#1E40AF] peer-checked:text-blue-800 dark:peer-checked:text-white hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                        <!--[if BLOCK]><![endif]--><?php if($key == 'desktop'): ?> <span class="material-symbols-outlined text-base">desktop_windows</span>
                                        <?php elseif($key == 'mobile'): ?> <span class="material-symbols-outlined text-base">smartphone</span>
                                        <?php elseif($key == 'tablet'): ?> <span class="material-symbols-outlined text-base">tablet_mac</span>
                         ...
                         <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedDevices'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                             <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $osOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label wire:key="os-<?php echo e($key); ?>" class="cursor-pointer">
                                    <input type="checkbox" wire:model.live="selectedOs" value="<?php echo e($key); ?>" class="sr-only peer">
                                    <div class="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium bg-[#F3F4F6] dark:bg-[#374151] text-[#111827] dark:text-[#F9FAFB] peer-checked:bg-[#DBEAFE] dark:peer-checked:bg-[#1E40AF] peer-checked:text-blue-800 dark:peer-checked:text-white hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                        <?php echo e($label); ?>
                         ...
                         <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedOs'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input wire:model="budget" class="w-full bg-[#FFFFFF] dark:bg-[#374151] border border-[#E5E7EB] dark:border-[#374151] text-[#111827] dark:text-[#F9FAFB] rounded-md focus:ring-[#3B82F6] focus:border-[#3B82F6] placeholder-[#9CA3AF] dark:placeholder-[#6B7280]" id="total-budget" placeholder="0.00" type="number"/>
                         <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['budget'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['daily_budget'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="md:col-span-2">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['daily_click_limit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
            ...
            <div class="bg-[#FFFFFF] dark:bg-[#1F2937] p-6 rounded-lg sticky top-8 border border-[#E5E7EB] dark:border-[#374151]">
                ...
                <div class="space-y-4 text-sm">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="font-medium text-[#111827] dark:text-[#F9FAFB] truncate"><?php echo e($name ?: 'Campaign Name'); ?></div>
                    </div>
                    <div class="space-y-1">
                        <div class="text-[#6B7280] dark:text-[#9CA3AF]">Target URL:</div>
                        <div class="font-medium text-[#3B82F6] truncate"><?php echo e($popup_url ?: 'https://example.com'); ?></div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <div class="text-[#6B7280] dark:text-[#9CA3AF]">Desired Clicks:</div>
                            <div class="font-medium text-[#111827] dark:text-[#F9FAFB]"><?php echo e(number_format((float)$desired_clicks)); ?></div>
                        </div>
                        <div>
                            <div class="text-[#6B7280] dark:text-[#9CA3AF]">Est. Cost:</div>
                            <div class="font-medium text-[#111827] dark:text-[#F9FAFB]">$<?php echo e(number_format((float)$calculated_cost, 2)); ?></div>
                        </div>
                    </div>
                    <hr class="border-[#E5E7EB] dark:border-[#374151]"/>
                    <div class="space-y-3">
                            ...
                            <div class="space-y-2">
                                <div>
                                    ...
                                    <div class="min-h-5 flex flex-wrap gap-1.5 items-center">
                                        <!--[if BLOCK]><![endif]--><?php if(count($selectedCountries) > 0): ?>
                                            <span class="px-2 py-1 text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 rounded-md"><?php echo e(count($selectedCountries)); ?> selected</span>
                                        <?php else: ?>
                                ...
                                <div>
                                    ...
                                    <div class="min-h-5 flex flex-wrap gap-1.5 items-center">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedAgeRanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $age): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="px-2 py-1 text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 rounded-md"><?php echo e($age); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="min-h-5 flex flex-wrap gap-1.5 items-center">
                                         <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedDevices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="flex items-center gap-1 px-2 py-1 text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 rounded-md">
                                                <?php echo e($deviceOptions[$device] ?? $device); ?>
                                ...
                                <div>
                                    ...
                                    <div class="min-h-5 flex flex-wrap gap-1.5 items-center">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedOs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $os): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="px-2 py-1 text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 rounded-md">
                                                <?php echo e($osOptions[$os] ?? $os); ?>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="font-medium text-[#111827] dark:text-[#F9FAFB]">$<?php echo e(number_format((float)$budget, 2)); ?></div>
                        </div>
                        <div>
                            <div class="text-[#6B7280] dark:text-[#9CA3AF]">Start Date:</div>
                            <div class="font-medium text-[#111827] dark:text-[#F9FAFB]"><?php echo e($start_date ? \Carbon\Carbon::parse($start_date)->format('d M, Y') : '-'); ?></div>
                        </div>
                        <div class="col-span-2">
                            <div class="text-[#6B7280] dark:text-[#9CA3AF]">Duration:</div>
                            <div class="font-medium text-[#111827] dark:text-[#F9FAFB]">
                                <!--[if BLOCK]><![endif]--><?php if($run_until_budget_depleted): ?>
                                    Ongoing (no end date)
                                <?php else: ?>
                                    <?php echo e($end_date ? \Carbon\Carbon::parse($end_date)->format('d M, Y') : 'Not set'); ?>
                    ...
                    <div class="mt-8">
                        <button type="button" wire:click="openConfirmationModal" wire:target="openConfirmationModal" wire:loading.attr="disabled" class="w-full bg-[#3B82F6] text-white font-semibold py-3 px-6 rounded-lg hover:bg-blue-600 transition-colors duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
                            <span wire:loading.remove wire:target="openConfirmationModal">Update Campaign</span>
    ...
    <div x-show="showConfirmModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm" style="display: none;">
        <div class="w-full max-w-2xl transform rounded-xl bg-[#1F2937] shadow-2xl transition-all border border-[#374151] p-8 relative">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-2xl font-bold text-[#F9FAFB]">Confirm Update</h3>
                <p class="mt-2 text-base text-[#9CA3AF]">Please review your campaign details. Are you sure you want to update this campaign?</p>
            </div>
            ...
            <div class="mt-8 space-y-5 rounded-lg border border-[#374151] bg-[#111827] p-6">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-4 text-sm sm:grid-cols-2">
                    <div>
                        ...
                        <div class="font-medium text-[#F9FAFB]"><?php echo e($name); ?></div>
                    </div>
                    <div>
                        <div class="text-[#9CA3AF]">Desired Clicks</div>
                        <div class="font-medium text-[#F9FAFB]"><?php echo e(number_format((float)$desired_clicks)); ?></div>
                    </div>
                    <div class="sm:col-span-2">
                        <div class="text-[#9CA3AF]">Target URL</div>
                        <div class="truncate font-medium text-[#F9FAFB]"><?php echo e($popup_url); ?></div>
                    </div>
                    <div>
                        <div class="text-[#9CA3AF]">Total Budget</div>
                        <div class="font-medium text-[#F9FAFB]">$<?php echo e(number_format((float)$budget, 2)); ?></div>
                    </div>
                    <div>
                        <div class="text-[#9CA3AF]">Daily Budget</div>
                        <div class="font-medium text-[#F9FAFB]">$<?php echo e(number_format((float)$daily_budget, 2)); ?></div>
                    </div>
                    <div>
                        <div class="text-[#9CA3AF]">Start Date</div>
                        <div class="font-medium text-[#F9FAFB]"><?php echo e($start_date ? \Carbon\Carbon::parse($start_date)->format('d M, Y') : '-'); ?></div>
                    </div>
                    <div>
                        <div class="text-[#9CA3AF]">End Date</div>
                        <div class="font-medium text-[#F9FAFB]"><?php echo e($run_until_budget_depleted ? 'Ongoing' : ($end_date ? \Carbon\Carbon::parse($end_date)->format('d M, Y') : '-')); ?></div>
                    </div>
                    <div class="sm:col-span-2">
                        <div class="text-[#9CA3AF]">Targeting</div>
                        <div class="font-medium text-[#F9FAFB]">
                            Countries: <?php echo e(count($selectedCountries)); ?> | Ages: <?php echo e(count($selectedAgeRanges)); ?> | Devices: <?php echo e(count($selectedDevices)); ?>
            ...
            <div class="mt-8 flex flex-col-reverse gap-4 sm:flex-row sm:justify-end">
                ...
                <button wire:click="updateCampaign" wire:loading.attr="disabled" class="w-full rounded-md bg-[#3B82F6] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-blue-600 sm:w-auto flex items-center justify-center gap-2 disabled:opacity-75 disabled:cursor-not-allowed">
                    <span wire:loading.remove wire:target="updateCampaign">Confirm & Update</span>
                    <span wire:loading wire:target="updateCampaign" class="material-symbols-outlined text-sm animate-spin">progress_activity</span>
                    <span wire:loading wire:target="updateCampaign">Updating...</span>
                </button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/livewire/user/edit-ad-campaign.blade.php ENDPATH**/ ?>