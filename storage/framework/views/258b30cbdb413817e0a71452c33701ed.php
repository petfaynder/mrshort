<div x-data="chartComponentData()">
    <div class="grid grid-cols-1 gap-8 mb-8">
        ...
        <div class="bg-card-light dark:bg-card-dark p-6 rounded-xl shadow-md">
            ...
            <!--[if BLOCK]><![endif]--><?php if($dailyStats->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $dailyStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayStats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-4 bg-background-light dark:bg-background-dark rounded-lg">
                            <p class="font-semibold text-heading-light dark:text-heading-dark"><?php echo e(\Carbon\Carbon::parse($dayStats['date'])->format('l, d M')); ?></p>
                            <p class="text-sm text-text-light dark:text-text-dark"><?php echo e($dayStats['views']); ?> Clicks</p>
                            <div class="mt-2 text-right">
                                <p class="font-bold text-green-500">$<?php echo e(number_format($dayStats['publisher_earnings'], 2)); ?></p>
                                <p class="text-sm text-text-light dark:text-text-dark">$<?php echo e(number_format($dayStats['cpm'], 2)); ?> CPM</p>
                            </div>
                        </div>
...
<script>
    function chartComponentData() {
        return {
            chart: null,
            init() {
                const initialData = <?php echo json_encode($statsData, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Tolga\Desktop\Proje Siteleri\linkkısaltmaservisi2\resources\views/livewire/user/earnings-chart.blade.php ENDPATH**/ ?>