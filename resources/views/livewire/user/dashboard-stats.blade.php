    ...
    <div class="bg-card-light dark:bg-card-dark p-4 rounded-xl shadow-md relative group">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-xl font-bold text-heading-light dark:text-heading-dark">{{ number_format($totalViews) }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-card-light dark:bg-card-dark p-4 rounded-xl shadow-md relative group">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-xl font-bold text-heading-light dark:text-heading-dark">{{ number_format($paidViews) }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-card-light dark:bg-card-dark p-4 rounded-xl shadow-md relative group">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-xl font-bold text-heading-light dark:text-heading-dark">${{ number_format($referralEarnings, 2) }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-card-light dark:bg-card-dark p-4 rounded-xl shadow-md relative group">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-xl font-bold text-heading-light dark:text-heading-dark">${{ number_format($averageCpm, 2) }}</p>
            </div>
        </div>
    </div>
</div>
