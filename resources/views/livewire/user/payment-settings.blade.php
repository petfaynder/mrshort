    ...
    <form wire:submit.prevent="saveSettings">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <label class="flex flex-col">
                <p class="text-heading-light dark:text-heading-dark text-sm font-medium leading-normal pb-2">Payment Method</p>
            ...
            <label class="flex flex-col">
                <p class="text-heading-light dark:text-heading-dark text-sm font-medium leading-normal pb-2">Account Details (Email, IBAN, etc.)</p>
                <input wire:model="paymentAccount" id="paymentAccount" type="text" class="form-input w-full rounded-lg text-white focus:outline-0 focus:ring-0 border border-[#324d67] bg-[#192633] focus:border-primary h-12 px-4 placeholder:text-[#92adc9] text-base font-normal leading-normal" placeholder="Enter your account details"/>
