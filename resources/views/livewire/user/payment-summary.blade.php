<div class="lg:col-span-2 bg-card-light dark:bg-card-dark p-6 rounded-xl shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <p class="text-3xl font-bold text-green-500">${{ number_format($balance, 2) }}</p>
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-heading-light dark:text-heading-dark">${{ number_format($threshold, 2) }}</p>
        ...
        <div>
            ...
            <p class="text-lg font-semibold text-heading-light dark:text-heading-dark">{{ $lastPaymentDate }}</p>
        </div>
        <div>
            <p class="text-sm text-text-light dark:text-text-dark mb-1">Next Payment Date</p>
            <p class="text-lg font-semibold text-heading-light dark:text-heading-dark">{{ $nextPaymentDate }}</p>
        </div>
    </div>
</div>
