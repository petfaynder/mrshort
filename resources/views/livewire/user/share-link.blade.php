<div>
    <!-- Share Button (small, for embedding) -->
    <button 
            ...
            <div class="bg-gray-900 rounded-2xl p-6 max-w-sm w-full mx-4 border border-purple-500/30 shadow-2xl">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <a 
                        ...
                        target="_blank"
                        wire:click="recordShare('twitter')"
                    ...
                    <a 
                        ...
                        target="_blank"
                        wire:click="recordShare('facebook')"
                        class="flex flex-col items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition"
                    >
                    ...
                    <a 
                        ...
                        target="_blank"
                        wire:click="recordShare('whatsapp')"
                        class="flex flex-col items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition"
                    >
                    ...
                    <a 
                        ...
                        target="_blank"
                        wire:click="recordShare('telegram')"
                        class="flex flex-col items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition"
                    >
                    ...
                    <!-- LinkedIn -->
                    <a 
                        href="{{ $this->getShareUrl('linkedin') }}" 
                        target="_blank"
                        wire:click="recordShare('linkedin')"
                        class="flex flex-col items-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition"
                    >
