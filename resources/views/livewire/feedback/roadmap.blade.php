<div class="py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <a href="{{ route('feedback.index') }}" class="inline-flex items-center gap-2 mt-4 text-primary hover:underline text-sm font-medium">
        ...
        <div class="bg-card-light dark:bg-card-dark rounded-2xl border border-border-light dark:border-border-dark p-8 md:p-12 text-center shadow-xl">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('feedback.index') }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold px-6 py-3 rounded-xl hover:shadow-lg transition-all duration-200 hover:scale-105">
                    <span class="material-symbols-outlined">lightbulb</span>
                    Submit Your Ideas
                </a>
                <a href="{{ route('feedback.index') }}?sort=popular" class="inline-flex items-center gap-2 bg-gray-100 dark:bg-gray-700 text-heading-light dark:text-heading-dark font-semibold px-6 py-3 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200">
