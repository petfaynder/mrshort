            ...
            <div class="flex flex-col max-w-md w-full gap-6 form-item-container">
                ...
                <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-4">
                    ...
                    <div class="flex items-center gap-3 animate-form-item" style="animation-delay: 0.8s;">
                        ...
                        I agree to the <a class="text-primary hover:underline font-medium" href="{{ route('terms.of.service') }}">Terms of Service</a> and <a class="text-primary hover:underline font-medium" href="{{ route('privacy.policy') }}">Privacy Policy</a>.
                        </label>
                    </div>
