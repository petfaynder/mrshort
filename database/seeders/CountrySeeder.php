...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        $countries = [
            ...
            ['name' => 'Congo, Democratic Republic of the', 'iso_code' => 'CD'],
            ...
            ['name' => 'Palestine, State of', 'iso_code' => 'PS'],
        ...
        $now = Carbon::now();
        $data = array_map(function ($country) use ($now) {
            return $country + ['created_at' => $now, 'updated_at' => $now];
        }, $countries);
